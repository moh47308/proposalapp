...
<div class="bg-gray p-4">
  <div class=" text-center page-title-box">
    ...
    <form action="{{url('client').'/'.$clients->id}}" class="" method="POST" enctype="multipart/form-data">
		@csrf
        @method("PUT")
    ...
    <div class="col-md-6">
      <input class="w-100 p-1 search-field no-bg mb-4 p-2 bg-light rounded-0" type="text"
						...
						id=""
						value="{{$clients->name}}" placeholder="Company Name">
						@error('name')
    ...
    <div class="col-md-4">
      <input class="w-100 p-1 search-field no-bg mb-4 p-2 bg-light rounded-0" type="text"
						...
						id=""
						value="{{$clients->first_name}}" placeholder="Forename">
						@error('first_name')
					<p class="alert alert-danger">
						{{$message}}
					</p>
    ...
    <div class="col-md-6">
      <input class="w-100 p-1 search-field no-bg mb-4 p-2 bg-light rounded-0" type="email"
						...
						placeholder="Email"
						id=""
						value="{{$clients->email}}"  placeholder="Email">
						 @error('email')
					<p class="alert alert-danger">
						{{$message}}
					</p>
    ...
    <div class="col-md-6">
      <input class="w-100 p-1 search-field no-bg mb-4 p-2 bg-light rounded-0" type="text" name="address_line_1"
						...
						id=""
						value="{{$clients->address_line_1}}" placeholder="Address 1">
    ...
    <div class="col-md-6">
      <input class="w-100 p-1 search-field no-bg mb-4 p-2 bg-light rounded-0" type="text"
						...
						class="form-control"
						id=""
						value="{{$clients->address_line_2}}" placeholder="Address 2">
    ...
    <div class="col-md-6">
      <input class="w-100 p-1 search-field no-bg mb-4 p-2 bg-light rounded-0" type="eamil" name="address_line_3"
						class="form-control"
						id=""
						value="{{$clients->address_line_3}}" placeholder="Address 3">
