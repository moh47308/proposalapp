...
@section('content')
    ...
    <div class="bg-gray p-4">
        ...
        <div class="row text-center mt-5 mb-5">
            <form class="create-proposal-form" action="{{ url('services/store') }}" method="POST">
                @csrf
                <div class="d-flex justify-content-between mb-1 align-items-center">Service Name</div>
                <input class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0" type="text" name="service_title"
                       placeholder="" value="{{old('service_title')}}">
                @error('service_title')
                ...
                <textarea name="description" class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0"
                ...
                <select id="listing"
                        class="w-100 p-1 search-field drop-down no-apperance p-2 bg-light rounded-0 service-type"
                ...
                <div class="price-box 1">
                    ...
                    <input id="one_off" class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0" type="text"
                           placeholder="£ 0.00" name="one_off" value="{{old('one_off')}}">
                </div>

                <div class="price-box 2">
                    <div class="d-flex justify-content-between mt-2 align-items-center">Price</div>
                    <input id="monthly" class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0" type="text"
                           placeholder="£ 0.00" name="monthly" value="{{old('monthly')}}">
                </div>

                <div class="price-box 3">
                    <div class="d-flex justify-content-between mt-2 align-items-center">Price</div>
                    <input id="quarterly" class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0" type="text"
                           placeholder="£ 0.00" name="quarterly" value="{{old('quarterly')}}">
                </div>

                <div class="price-box 4">
                    <div class="d-flex justify-content-between mt-2 align-items-center">Price</div>
                    <input id="annual" class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0" type="text"
                           placeholder="£ 0.00" name="annual" value="{{old('annual')}}">
                </div>

                <div class="price-box 5">
                    <div class="d-flex justify-content-between mt-2 align-items-center">Price</div>
                    <input id="volume_base" class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0" type="text"
                           placeholder="£ 0.00" name="volume_base" value="{{old('volume_base')}}">
                </div>
                ...
                <div class="wrapper-range price-box 6">
                    <div class="ranges">
                        ...
                        <input id="range" class="w-100 p-1 search-field no-bg p-2 bg-light rounded-0" type="text"
                               placeholder="1k to 2k" name="range[]" >
                        <div class="d-flex justify-content-between mt-2 align-items-center">Price</div>
