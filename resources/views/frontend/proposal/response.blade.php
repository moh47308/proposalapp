...
@elseif(session()->get('action') == 2)
	<form action="{{url('proposal/suggetions').'/'.session()->get('proposal_id')}}" method="get" >
	 	<div class="container-fluid h-100">
  			<div class="container-fluid h-100">
    			<div class="row no-gutters h-100">
					<div class="col-3"><img style="padding: 50px;" src="{{ url("public/assets/forntend/") }}/images/EziProposal.png">
					</div>
		 			<div class="col-9">
		 				<ul style="background-color: #FFFFFF; padding-top: 30px; border-top-right-radius: 10px;">
							<li style="font-weight: 800; color: #304B74; font-size: 22px;">
								<img
								src="{{ url("public/assets/forntend/") }}/images/dashboard-color-icon.svg">
							Proposal
							</li>
							<li style="font-weight: 700; color: #304B74; font-size: 22px;">Ref No:@if($proposal_details){{ $proposal_details["ref_no"] }}@endif 
							</li>
							...
							<?php $today = date("j F, Y"); ?>
							<li style="font-weight: 700; color: #4B874C;"><img src="{{ url("public/assets/forntend/") }}/images/date-icon.svg" style="padding-right: 5px;">		
							<?php echo $today; ?>
							</li>
						</ul>
						<label class="message">Tell how to improve</label><br>
		 				<textarea required rows="6" cols="50" name="suggetions"></textarea>
