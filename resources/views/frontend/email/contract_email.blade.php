...
<div class="container">
	<div class="row">
		...
		<div class="col-6" style="background-color: rgba(255, 255, 255, 1); padding: 50px 100px;">
			...
			<?php $today = date("d/m/y",strtotime($data['proposal_details']['created_at'])); ?>
      ...
      <ol start="1" type="1">
	      <li>
          <strong>{{ $data['client_detail']["name"] }} [the       Buyer]</strong> of (the &quot;Buyer&quot;); and 
        </li>
        <li>
          <strong>{{ $data['company_detail']["name"] }}    [the Service Provider]</strong> of (the &quot;Service       Provider&quot;), 
        </li>
      </ol>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    <td width="40%"><p><strong>{{ $data['client_detail']["name"] }} [the Buyer]</strong></p></td>
    <td width="60%"><p>)</p></td>
  </tr>
</table>
<table border="0" cellspacing="0" cellpadding="0" width="100%">
  ...
  <tr>
    <td width="40%"><p><strong>{{ $data['company_detail']["name"] }}[the Service Provider]</strong></p></td>
    <td width="60%"><p>) </p></td>
  </tr>
</table>
<p>ANNEX 1</p>
